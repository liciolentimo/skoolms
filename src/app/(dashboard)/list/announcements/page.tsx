...
import { announcementsData, classesData, eventsData, examsData, lessonsData, parentsData, resultsData, role, studentsData, subjectsData, teachersData } from "@/lib/data";
        ...
        <tr key={item.id} className="border-b border-gray-200 even:bg-slate-50 text-sm hover:bg-myPurpleLight">
            ...
            <td>
               ...
               {role === "admin"  && (
                ...
                // </button>
                <>
                <FormModal table="announcement" type="edit" data={item} />
